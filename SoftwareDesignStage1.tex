...
\begin{center}
	\begin{tabular}{|c|c|p{10cm}}
		\hline
		Project Name & Tempest Trace \\
		\hline
		Client/Supervisor and email & Patrick Marais , patrick@cs.uct.ac.za\\
		\hline
		Tutor and email &Codie Roelf, Codie.Roelf@alumni.uct.ac.za\\
		\hline
		Date & 31 July 2015\\
		\hline
		Team Members & Name, Surname, Student number and email \\
		\hline
		 & Jacques Heunis, HNSJAQ003, hnsjaq003@myuct.ac.za\\
		\hline
		& Brian Mc George, MCGBRI004, mcgbri004@myuct.ac.za\\
		\hline
		& Timothy Gwynn, GWYTIM001,gwytim001@myuct.ac.za\\
		\hline
		Team Leader (Jacques Heunis) &\parbox{9cm}{ Coordinate team members, identify and deal with any problems arising, Lead programmer}\\
		\hline
		Architect (Timothy Gwynn) &\parbox{9cm}{ Responsible for game design and input regarding gameplay and mechanics, integrate art and sound into game}\\
		\hline
		Communicator (Brian Mc George) & \parbox{9cm}{Ensure Documentation is correct  record meetings and design decisions, overview records, handle communication with artists and sound engineers}\\
		\hline
	\end{tabular}
\end{center}
\section{Scope}
