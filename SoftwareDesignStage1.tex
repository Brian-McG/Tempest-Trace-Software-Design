...
The most experienced programmer, often consulted if other team members require assistance with their code, ensures that the team's code is consistent and compatible within itself.
\subsection{Timothy Gwynn}
\textbf{Architect}\\
Responsible for game design and input regarding gameplay and mechanics, integrate art and sound into game.\\\\
\textbf{Level Designer}\\
In charge of overall level design, ensures that the level supports the gameplay options provided by the team. Is also responsible for the robustness of the level and fixing bugs in the game world.
\subsection{Brian Mc George}
\textbf{Communicator}\\
The Communicator is in charge of mainataining all documentation for the project and recording details from meetings. He is also in charge of handling communication with the external project members such as the visual and sound artists.\\\\
\textbf{AI Programmer}\\
...
\subsection{Floating Roles}\\
\textbf{Quality Assurance}\\
All team members will fulfill this role at some point in ensuring that both their work and the rest of the team's work is of a high quality, is bug free and is consistent with the rest of the project.\\\\
