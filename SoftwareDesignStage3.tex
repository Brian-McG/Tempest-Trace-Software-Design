...
Takes a set of empty game objects and lerps the camera to each objects position and rotation in turn. The functionality is complete. Once the world is finalised the final flyover way-points and speed of fly over will be set. 
